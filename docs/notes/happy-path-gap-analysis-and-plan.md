...
> **⚠️ §2 現状マップ・§3 安定化・§6 Issue 対応表は陳腐化。** 実コード再検証に基づく正本は
> [`happy-path-status-2026-07-08.md`](happy-path-status-2026-07-08.md) を参照。HP7 の設計判断は
> [ADR-0059](../adr/0059-inquiry-logic-tree.md) を正本とする。
> 本書は §1 HP 定義・§4 段階方針の背景として残す。
