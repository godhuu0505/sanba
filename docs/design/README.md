...
| 種別 | 内容 | リンク |
|---|---|---|
| 🎨 Design | 「ライブ対話」の **デスクトップ / スマホ / タブレット** ＋ **完成イメージ・プレビュー** ＋ **マルチモーダル入力** | [figma.com/design/eI6QvvCEO021zpdMmxr8Iq](https://www.figma.com/design/eI6QvvCEO021zpdMmxr8Iq) |
