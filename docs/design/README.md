...
> 会話フェーズ（03〜08）の刷新案は **[`conversation-experience-v2.md`](conversation-experience-v2.md)**
> （会話を止めない 3 タブ・選択肢 3 モード ほか。navigation は [ADR-0018](../adr/0018-conversation-experience-v2.md) で ADR-0017 を一部改訂）。
...
各画面の要件は [`screens/`](screens/)、会話フェーズ v2 の詳細は [`conversation-experience-v2.md`](conversation-experience-v2.md) を参照。
...
> **会話フェーズ（03〜08）は v2 へ改訂**（2026-06-25 / [ADR-0018](../adr/0018-conversation-experience-v2.md)・ADR-0017 navigation を一部改訂）。
> 旧 03〜10 票は v2 票へ統合。
