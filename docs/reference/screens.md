...
Playwright で撮影したもの（原則モバイル幅 420px。PC 2 カラムレイアウトの
`screens/15-session-pc.png` のみ 1440px）。データはすべてダミー。
...
セッション中の会話画面は lg（1024px）以上で 2 カラム表示になる。左カラムは音声状態に連動した
サンバのイラストとステータス、右カラムは会話履歴・参考資料・要件一覧のタブ。1440px で撮影。
